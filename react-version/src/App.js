              ...
              <div className="flex md:justify-end">
                <div className="space-y-6 md:basis-7/12 lg:flex-none lg:basis-1/2 lg:space-y-6">
                  ...
                  <p className="break-words font-open-sans text-xl leading-loose text-tertiary">
                    ...
                    the computer. I used to play a lot of Soccer ⚽.
                  </p>
                </div>
              </div>
              <div className="flex">
                  ...
                  <div className="flex flex-col-reverse items-center gap-12 md:flex-row lg:gap-16">
                    <div className="flex-none space-y-16 font-open-sans md:w-5/12">
                      <div className="space-y-4">
                        ...
                        <div className="font-bold">Toronto, Canada</div>
                        <div className="text-tertiary">
                          I love me a good Maple Syrup. 🇨🇦🍁🥞
                        </div>
                      </div>
                      <div className="space-y-4">
                        <span className="rounded-md bg-quaternary py-2 px-6 font-bold text-secondary">
                        ...
                        <div className="text-tertiary">
                          Bachelor from University of London in UK and Computer Programming Analysis Student in Toronto Canada.
                        </div>
                      </div>
                      <div className="space-y-4">
                        <span className="rounded-md bg-quaternary py-2 px-6 font-bold text-secondary">
                        ...
                        <div className="font-bold">2 Years of Experience</div>
                        <div className="text-tertiary">
                          I started with making macros for my games and now i am really into Software Dev and Data Analytics.
                        </div>
                      </div>
                    </div>
